...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/LoneMonk298' },
    {
      icon: {
  ...
  footerConfig: {
    ...
    icpRecordCode: '蜀ICP备xxxx-1', // ICP备案号
    publicSecurityRecordCode: '蜀公网安备xxxx号', // 联网备案号
    copyright: `Copyright © 2023-${new Date().getFullYear()} lonemonk` // 版权信息
  }
}
